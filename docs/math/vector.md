...
**平行向量**：方向相同或相反的两个 **非零** 向量。记作：$\boldsymbol a\parallel \boldsymbol b$。对于多个互相平行的向量，可以任作一条直线与这些向量平行，那么任一组平行向量都可以平移到同一直线上，所以平行向量又叫 **共线向量**。**特殊地，我们规定零向量与任何向量都为平行向量，记作 $\vec 0$ ∥ &\vec a& **
...
## 极坐标与极坐标系(人教版高中数学选修4-4内容  2004年版)
